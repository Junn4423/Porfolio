      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            <Link
              href="/"
              className="text-2xl font-bold text-emerald-900 dark:text-emerald-400"
            >
              Chung<span className="text-neutral-400">.</span>dev
            </Link>
            <p className="mt-3 text-sm text-neutral-500 dark:text-neutral-400 leading-relaxed max-w-xs">
          ...
          <div>
            ...
            <div className="flex flex-col gap-3 text-sm text-neutral-500 dark:text-neutral-400">
              <a
                href={`mailto:${personal.email}`}
                className="flex items-center gap-2 hover:text-emerald-900 dark:hover:text-emerald-400 transition-colors"
              >
